...
<?php // $cnt=$cnt+1;}} ?>                      
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">1997-01-25</td>
                                                <td class="center">for modification entered the subject or article title string</td>
                                                <td class="center">Amar Ujala</td>
                                                <td class="center">07-05-2021</td>
                                                <td class="center"><a href="#" class="btn btn-success btn-xs">View</a></td>
                                            </tr>
                                            <tr class="odd gradeX">
