                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-news.php">Add Newspaper</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-news.php">Manage Newspaper</a></li>
                                </ul>
                            </li>
<!--                            <li>
...
<li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> User's <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-user.php">Add User</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-news.php">Manage User</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
