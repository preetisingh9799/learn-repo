...
<div class="panel-body">
        ...
        <input class="form-control" type="date" name="bookname" autocomplete="off"  required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <label>News Articla<span style="color:red;">*</span></label>
        <textarea class="form-control"></textarea>
        </div>
        <div class="form-group">
        <label>Upload Pdf<span style="color:red;">*</span></label>
        <input class="form-control" type="file" name="bookname" autocomplete="off"  required />
        </div>
